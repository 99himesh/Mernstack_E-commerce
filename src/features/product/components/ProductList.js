...
export default function ProductList() {
  ...
  const categaries=useSelector(selectCategary)
  ...
  useEffect(()=>{
    dispatch(fetchAllCategaryAsync())
  ...
  return (
    <div>
      <div>
        ...
        {/* productList here */}
        <Pagination page={page} setPage={setPage} handlePagination={handlePagination} totalItem={100} />
      </div>
    </div>
